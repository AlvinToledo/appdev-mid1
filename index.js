...
//then in index.html i change the picture at the buttom the 3 script src ay nasa baba ng div if the mouse direct the the picture its automatic moving at if the mouse is not moving or touch the picture the picture is back to normal 